...
namespace KLabs.AnimatorOverrideController
{
	[ScriptedImporter(1, "aoc")]
	public class XmlAocImporter : ScriptedImporter
	{
		public override void OnImportAsset(AssetImportContext ctx)
		{
			var aoc = new UnityEngine.AnimatorOverrideController();
			ctx.AddObjectToAsset(nameof(AnimatorOverrideController), aoc);
			ctx.SetMainObject(aoc);
